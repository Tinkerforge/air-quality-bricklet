...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    // Create receiver for all values events.
    let all_values_receiver = aq.get_all_values_receiver();

    // Spawn thread to handle received events. This thread ends when the `aq` object
